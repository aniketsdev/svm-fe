  ...
  return (
    <div ref={containerRef} className="relative hidden w-56 sm:block md:w-72" data-slot="header-search">
      ...
      <input
        ...
        className="h-9 w-full rounded-md border border-border bg-background pl-9 pr-3 text-sm text-foreground placeholder:text-muted-foreground focus:border-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      />
